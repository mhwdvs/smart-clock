...
enum OpCode {
    ...
    QualityHigh = 0x20,  // medium sensitivity
    QualityHigh2 = 0x21, // high sensitivity
    QualityLow = 0x23,   // low sensitivity
}
...
impl BH1750 {
    pub fn measure_brightness() -> Result<(), InputError> {
        ...
        _  = channel.set_slave_address(BH1750_ADDR);
